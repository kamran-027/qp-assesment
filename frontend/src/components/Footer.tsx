const Footer = () => {
  return (
    <div className="text-center h-full p-2">
      <footer className="flex items-center justify-center gap-x-2">
        <a
        ...
        <a
          href="https://www.linkedin.com/in/kamran-khan-065124104/"
          className="social-icon"
          target="_blank"
        >
      ...
      <div className="text-sm mt-1 font-light">
        Copyright©{new Date().getFullYear()} by Kamran Khan
      </div>
    </div>
  );
};
